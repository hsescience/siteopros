...
{
    public class Dimension      //class containing information about Hofstede cultural dimension
    {
        private string name_ru; //dimension's name in Russian
        public string _name_ru
        {
            get { return name_ru; }
        }

        private string name_en; //dimension's name in English
        public string _name_en
        {
            get { return name_en; }
        }

        private string name_short; //dimensions's short name
        ...
        public Dimension(string name_ru, string name_en, string name_short, List<double> levels) //constructor
        {
        ...
        //===============methods for creating etalon dimensions===============
