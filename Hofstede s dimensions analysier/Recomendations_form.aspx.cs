...
namespace Hofstede_s_dimensions_analysier
{
    public partial class Recomendations_form : System.Web.UI.Page
    {
        ...
        public static string[, , , , ,] hypercube;      //hypercube of recomendation sets
        ...
        string country = ""; //selected country name
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                stoper = true;
                //getting Hofstede dimensions ranks from page adress
                ...
                //getting country name from page adress
                try
                {
                    string[] tempCountry = Request.QueryString.GetValues("Country");
                ...
                //dropping list of recomendation sets
        ...
        protected void Button12_Click(object sender, EventArgs e)   //method for getting feedback
        {
